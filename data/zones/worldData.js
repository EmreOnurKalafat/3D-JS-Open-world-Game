// data/zones/worldData.js — Procedural city data (zone configs, vehicle weights, colors)
// Extracted from world.js for data-driven architecture.
...
/** Zone → facade base color (CSS string) */
export const ZONE_FACADE_COLORS = {
  downtown_core: '#7080A0',
  downtown:      '#7890A0',
  commercial:    '#C0A080',
  residential:   '#D0A878',
  suburban:      '#D8C0A0',
