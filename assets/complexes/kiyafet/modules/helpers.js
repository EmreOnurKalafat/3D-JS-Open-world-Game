// assets/complexes/kiyafet/modules/helpers.js
// Primitive placement helpers. ALL kiyafet modules use these.
import * as THREE from 'three';
import { GEO } from '../../../resources.js';
import { gmx, gmz, MODULE_SRC_PREFIX } from '../constants.js';
...
export function b(g, sx, sy, sz, lx, ly, lz, mat, ry = 0, physicsBodies = null) {
  ...
  m.position.set(gmx(lx), ly, gmz(lz));
...
/** Physics-enabled wall box — pushes to physicsBodies. */
...
export function ptl(g, color, intens, dist, lx, ly, lz) {
  ...
  l.position.set(gmx(lx), ly, gmz(lz));
...
export function placePrefab(parent, prefabGroup, lx, ly, lz, ry = 0) {
  prefabGroup.position.set(gmx(lx), ly, gmz(lz));
